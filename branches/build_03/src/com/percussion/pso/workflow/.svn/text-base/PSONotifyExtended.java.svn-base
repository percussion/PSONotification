...
/**
   ...
   private static PSComponentSummary getComponentSummary(IPSRequestContext req) 
   {
   ...
   private class AddressCreatorIterator implements Iterator
   {
      ...
      private AddressCreatorIterator(IPSRequestContext request, Iterator source, String communityId)
      {
         this.req = request;
         this.source = source;
