 ...
 * @author davidbenua
 */
public class PSMailMessageCtxWritable implements IPSMailMessageWritable, IPSMailMessageContext, Serializable
{
   /**
    * @see com.percussion.workflow.mail.IPSMailMessageWritable#getCCList()
    */
   public Set<PSCaseInsensitiveString> getCCList()
   {
      return m_Cc; 
   }
    ...
    */
   public Set<PSCaseInsensitiveString> getToList()
   {
      return m_To; 
   }
   ...
   public PSMailMessageCtxWritable(String from, Set<String> to, Set<String> cc,
    ...
    */
   private Set<PSCaseInsensitiveString> m_To = new LinkedHashSet<PSCaseInsensitiveString>(); 

   /**
    * CC list users a copy of the mail notification is to be sent.
    */
   private Set<PSCaseInsensitiveString> m_Cc = new LinkedHashSet<PSCaseInsensitiveString>();
   ...
   public void addCC(Iterator<String> list)
   {
      while(list.hasNext())
      { 
         PSCaseInsensitiveString cis = 
            new PSCaseInsensitiveString(list.next()); 
         m_Cc.add(cis);   
      }
    ...
    */
   public void addTo(Iterator<String> list)
   {
      while(list.hasNext())
      { 
         PSCaseInsensitiveString cis = 
